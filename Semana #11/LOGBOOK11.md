...
![CA-TRUE](Images/Task1-CA-True.png)
...
![Self-Identifying](Images/task-1-self-identifying.png)

*In the RSA algorithm, we have a public exponent e, a private exponent d, a modulus n, and two secret
numbers p and q, such that n = pq. Please identify the values for these elements in your certificate
and key files.*

![public-exponent](Images/task1-publicExponent.png)
![private-exponent](Images/task1-privateExponent.png)
![modulus](Images/task1-modulus.png)
![prime1-prime2](Images/task1-prime1prime2.png)
